...
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Abs;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Acos;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Asin;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Atan;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Atan2;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Ceiling;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Conv;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Cos;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Cot;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Crc32;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Degrees;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Exp;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Floor;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Log;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Log10;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Log2;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Oct;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Pi;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Pow;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Radians;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Rand;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Round;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Sign;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Sin;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Sqrt;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Tan;
import com.baidu.hsb.parser.ast.expression.primary.function.arithmetic.Truncate;
import com.baidu.hsb.parser.ast.expression.primary.function.bit.BitCount;
import com.baidu.hsb.parser.ast.expression.primary.function.comparison.Coalesce;
import com.baidu.hsb.parser.ast.expression.primary.function.comparison.Greatest;
import com.baidu.hsb.parser.ast.expression.primary.function.comparison.Interval;
import com.baidu.hsb.parser.ast.expression.primary.function.comparison.Isnull;
import com.baidu.hsb.parser.ast.expression.primary.function.comparison.Least;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Adddate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Addtime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.ConvertTz;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Curdate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Curtime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Date;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.DateAdd;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.DateFormat;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.DateSub;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Datediff;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Dayname;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Dayofmonth;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Dayofweek;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Dayofyear;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.FromDays;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.FromUnixtime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Hour;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.LastDay;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Makedate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Maketime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Microsecond;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Minute;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Month;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Monthname;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Now;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.PeriodAdd;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.PeriodDiff;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Quarter;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.SecToTime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Second;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.StrToDate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Subdate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Subtime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Sysdate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Time;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.TimeFormat;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.TimeToSec;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Timediff;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Timestamp;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.ToDays;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.ToSeconds;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.UnixTimestamp;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.UtcDate;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.UtcTime;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.UtcTimestamp;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Week;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Weekday;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Weekofyear;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Year;
import com.baidu.hsb.parser.ast.expression.primary.function.datetime.Yearweek;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.AesDecrypt;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.AesEncrypt;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Compress;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Decode;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.DesDecrypt;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.DesEncrypt;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Encode;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Encrypt;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Md5;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.OldPassword;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Password;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Sha1;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Sha2;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.Uncompress;
import com.baidu.hsb.parser.ast.expression.primary.function.encryption.UncompressedLength;
...
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.BitAnd;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.BitOr;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.BitXor;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.Std;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.Stddev;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.StddevPop;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.StddevSamp;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.VarPop;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.VarSamp;
import com.baidu.hsb.parser.ast.expression.primary.function.groupby.Variance;
import com.baidu.hsb.parser.ast.expression.primary.function.info.Benchmark;
import com.baidu.hsb.parser.ast.expression.primary.function.info.Charset;
import com.baidu.hsb.parser.ast.expression.primary.function.info.Coercibility;
import com.baidu.hsb.parser.ast.expression.primary.function.info.Collation;
import com.baidu.hsb.parser.ast.expression.primary.function.info.ConnectionId;
import com.baidu.hsb.parser.ast.expression.primary.function.info.CurrentUser;
import com.baidu.hsb.parser.ast.expression.primary.function.info.Database;
import com.baidu.hsb.parser.ast.expression.primary.function.info.FoundRows;
import com.baidu.hsb.parser.ast.expression.primary.function.info.LastInsertId;
import com.baidu.hsb.parser.ast.expression.primary.function.info.RowCount;
import com.baidu.hsb.parser.ast.expression.primary.function.info.User;
import com.baidu.hsb.parser.ast.expression.primary.function.info.Version;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.Analyse;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.Default;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.GetLock;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.InetAton;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.InetNtoa;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.IsFreeLock;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.IsUsedLock;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.MasterPosWait;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.NameConst;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.ReleaseLock;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.Sleep;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.Uuid;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.UuidShort;
import com.baidu.hsb.parser.ast.expression.primary.function.misc.Values;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Ascii;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Bin;
import com.baidu.hsb.parser.ast.expression.primary.function.string.BitLength;
import com.baidu.hsb.parser.ast.expression.primary.function.string.CharLength;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Concat;
import com.baidu.hsb.parser.ast.expression.primary.function.string.ConcatWs;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Elt;
import com.baidu.hsb.parser.ast.expression.primary.function.string.ExportSet;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Field;
import com.baidu.hsb.parser.ast.expression.primary.function.string.FindInSet;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Format;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Hex;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Insert;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Instr;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Left;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Length;
import com.baidu.hsb.parser.ast.expression.primary.function.string.LoadFile;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Locate;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Lower;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Lpad;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Ltrim;
import com.baidu.hsb.parser.ast.expression.primary.function.string.MakeSet;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Ord;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Quote;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Repeat;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Replace;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Reverse;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Right;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Rpad;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Rtrim;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Soundex;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Space;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Strcmp;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Substring;
import com.baidu.hsb.parser.ast.expression.primary.function.string.SubstringIndex;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Unhex;
import com.baidu.hsb.parser.ast.expression.primary.function.string.Upper;
